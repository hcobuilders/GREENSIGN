export const modules = [
  ...
  ["project-intelligence","V2","Project Intelligence","Initiate projects, track milestones, surface risk, budget and forecast signals."],
...
export const globalLinks = [["dashboard","Dashboard"],["projects","Projects"],["data","Data"],["network","Network"]] as const;
export const settingsLinks = [["account","Account info"],["company","Company info"],["contacts","Contacts & trades"],["features","Manage features"],["connections","Connections"],["subscription","Subscription"]] as const;
